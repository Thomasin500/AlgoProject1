...
/*
Note:  this file declares 3 functions and 4 templates.
The Swap template is necessary for the function implementations to run,
but the others are provided as a convenience.
*/
...
void copyArray(Comparable a[], Comparable b[]) {
...
Precondition:   array a and  array b
